...
public class TheStage {
	...
	static int output_password_length = setLength();
	...
	private static String getNextRandomPassword(String strPossibleCaps, String strPossibleLows, String strPossibleSymbs, String strPossibleNums, Random random) {
		...
		/*incidentally, this code forces the password to adhere to a specific sequence.
		* I want this because I need to ensure that the password I use is generated by this script.
		*/
